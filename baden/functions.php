...
add_action( 'after_setup_theme', 'baden' );

function change_menu() {
  register_nav_menu('menu',__( 'Меню' ));
}
add_action( 'init', 'change_menu' );

add_action('init', 'my_custom_init');
function my_custom_init(){
	register_post_type('planirovka', array(
		'labels'             => array(
			'name'               => 'Планировки',
			...
			'view_item'          => 'Посмотреть Планировку',
			'search_items'       => 'Найти Планировку',
			'not_found'          => 'Планировок не найдено',
			'not_found_in_trash' => 'В корзине Планировок не найдено',
...
function customize_register_action( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'title_tagline_logo2',
			array(
				'label'    => 'Логотип для остальных страниц',
				'settings' => 'title_tagline_logo2',
